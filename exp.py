...
class Sut:
    def __init__(self, name, timeWeight, platform, url=None):
        self.name = name
...
## Local configurations
    ...
    SUTS = [
        ...
        Sut("stanford-hivdb", 1, JDK_8, url="https://hivdb.stanford.edu/graphql"),
        Sut("countries-trevorblades", 1, JDK_8, url="https://countries.trevorblades.com"),
        Sut("etmdb", 1, JDK_8, url="https://etmdb.com/graphql"),
        Sut("everbase", 1, JDK_8, url="https://api.production.everbase.co/graphql"),
        ...
        Sut("countries-274616", 1, JDK_8, url="https://countries-274616.ew.r.appspot.com/"),
        Sut("spacex", 1, JDK_8, url=" https://api.spacex.land/graphql/"),
        Sut("rickandmortyapi", 1, JDK_8, url=" https://rickandmortyapi.com/graphql"),
        Sut("bahnql-herokuapp", 1, JDK_8, url="https://bahnql.herokuapp.com/graphql"),
        ...
        #Sut("quintero", 1, JDK_8, url="https://tmdb.apps.quintero.io/"),
    ]
...
def getConfigs():
    ...
    CONFIGS.append(Config(True, False, 60))
